...
import com.ramapay.app.util.ShortcutUtils;
import com.ramapay.app.viewmodel.DappBrowserViewModel;
import com.ramapay.app.viewmodel.TokenFunctionViewModel;
...
import com.ramapay.app.widget.CertifiedToolbarView;
        ...
        OnEthCallListener, OnWalletAddEthereumChainObjectListener, OnWalletActionListener
{
    ...
    private void showErrorDialogIncompatibleNetwork(long callbackId, long requestingChainId, long activeChainId)
    {
        if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED))
        {
            ...
            String message = com.ramapay.app.repository.EthereumNetworkBase.isChainSupported(requestingChainId) ?
                    getString(R.string.error_eip712_incompatible_network,
                            com.ramapay.app.repository.EthereumNetworkBase.getShortChainName(requestingChainId),
                            com.ramapay.app.repository.EthereumNetworkBase.getShortChainName(activeChainId)) :
